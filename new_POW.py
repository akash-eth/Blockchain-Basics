...
"""WE ARE DEVELOPING A BLOCKCHAIN NETWORK WITH A NEW PROOF OF WORK CALCULATION"""
#-----------------------------Importing Libraries------------------------------------------
import hashlib
import datetime
import json
...
class Blockchain:
    ...
    def proof_of_work(self, previous_proof):
        ...
        while check_proof is False:
            hash_operation = hashlib.sha256(str(new_proof**2*17 - previous_proof**2*17).encode()).hexdigest()
